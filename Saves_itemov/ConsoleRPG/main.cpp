...
void main()
{
	...
	if (SaveExists())
	{
		...
		else
		{
			...
			else if (player.name == "Геральт из ривии")
			{
				cout << "Вы вписали секретное имя!" << endl;
				cout << "+ второй меч за спиной" << endl;
				cout << "+ второй меч в трусах" << endl;
				cout << "+ легенды о вас" << endl;
				cout << "- женщины" << endl;
				cout << "- надо выпить" << endl;
				player.healthFlasks = 640;
			}
