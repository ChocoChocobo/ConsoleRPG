...
void main()
{
	...
	Item item4("Осколок сновидения", "Хранит энергию несовершенных желаний. Теплится изнутри", 15, 2);
	Item item5("Сердце механического жука", "Тикает, как карманные часы. Пахнет озоном и сталью", 30, 1);
	Item item6("Карта теней", "На ней отмечены только места, где ты уже побывал. И несколько, где тебя точно ждут", 3, 1);
