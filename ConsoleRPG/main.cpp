...
// СОЗДАЕМ ВЕКТОР ТОВАРОВ ДЛЯ МАГАЗИНА
	vector<Item> shopItems = {
		...
		Item("Laptop", "Мощный ноутбук для программирования", 999.99, 10),
		Item("Smartphone", "Современный смартфон", 699.99, 25),
		Item("Headphones", "Качественные наушники", 149.99, 50),
		Item("Keyboard", "Механическая клавиатура", 79.99, 30),
		Item("Mouse", "Игровая мышь", 29.99, 40)
	};
